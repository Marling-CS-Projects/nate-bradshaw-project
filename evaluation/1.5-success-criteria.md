...
\*two images from generations apart or video\*

From testing the simulation by leaving it running for (X) generations, it can be safely determined that the neuroevolution is improving the creatures over the generations.
