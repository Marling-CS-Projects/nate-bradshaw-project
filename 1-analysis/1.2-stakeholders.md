...
The consideration for teachers would be firstly how learning can be boosted and complimented for a students learning, and secondly the time that can be saved for the teacher when planning lessons to utilise educational games.  \
\
\
considering how well a game could compliment other teaching [(Felicia, 2020)](../analysis/references.md)

considering how games could reduce the workload for teachers so they can preform other important activities

considering accuracy to curriculums and customisability for teachers
